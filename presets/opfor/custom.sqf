...
opfor_marksman = "CUP_B_BAF_Spotter_L85TWS_DPM";                                       // Marksman
...
opfor_medic = "CUP_B_BAF_Soldier_Medic_DPM";                                              // Combat Life Saver
...
opfor_battlegroup_vehicles = [
	...
	"CUP_B_Wolfhound_GMG_GB_W",
	"CUP_B_Wolfhound_HMG_GB_W",
	"CUP_B_Wolfhound_LMG_GB_W","CUP_B_AH1_DL_BAF",                                      // 
    "CUP_B_AW159_RN_Blackcat",                                 //
	"CUP_B_AW159_Unarmed_RN_Blackcat",                                 //
	"CUP_B_AW159_GB",                                 //
	"CUP_B_AW159_Unarmed_GB",                                 //
...
opfor_battlegroup_vehicles_low_intensity = [
	...
	"CUP_B_Wolfhound_GMG_GB_W",
	"CUP_B_Wolfhound_HMG_GB_W",
	"CUP_B_Wolfhound_LMG_GB_W",                                          // ZSU-39 Tigris
	"CUP_B_Merlin_HC3A_Armed_GB",                                 //
	"CUP_B_Merlin_HC3A_GB"                                 //
];
...
opfor_choppers = [
    "CUP_B_AH1_DL_BAF",                                      // Mi-290 Taru (Bench)
    "CUP_B_AW159_RN_Blackcat",                                 //
	"CUP_B_AW159_Unarmed_RN_Blackcat",                                 //
	"CUP_B_AW159_GB",                                 //
	"CUP_B_AW159_Unarmed_GB",                                 //
